...
ft_realloc.c  ft_new_path.c ft_get_tfile.c ft_itoa_base_unintmax.c \
ft_get_file_inf.c ft_free_tfile.c ft_new_tfile.c \
ft_putstr_color_fd.c ft_sort_tfile.c ft_freestrarr.c \
ft_str_startwith.c ft_strsplit_whitespace.c ft_char_to_str.c \
ft_itoa_base_intmax.c ft_stradd_char.c ft_strjoin_fr.c ft_arr_to_str.c \
